...
type (
	...
	exporter interface {
		ToConfig(ctx context.Context, pkg *domain.PackageConfig, destination, fileType string) (string, error)
	}
...
func ToTOML(ctx context.Context, pkg *domain.PackageConfig, destination string) (string, error) {
...
func ToJSON(ctx context.Context, pkg *domain.PackageConfig, destination string) (string, error) {
